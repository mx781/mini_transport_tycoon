...
val init_game: string -> game_state


(* main_loop is the main REPL for the game. It takes in a game_state and
 * updates everything within the game_state (location, vehicles, players)
 * so that the game updates by one game_step, evaluating to the updated
 * game_state.*)
