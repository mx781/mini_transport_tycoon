module rec Gameelements_piqi:
  sig
    ...
    type goodopt =
      [
        | `none
        | `some of Gameelements_piqi.good
      ]
    type good = Good.t
...
and Goodsprofile:
  sig
    type t = {
      ...
      mutable price: Gameelements_piqi.float;
      mutable naturalprice: Gameelements_piqi.float;
    }
  end = Goodsprofile
and Location:
  sig
...
and Connection:
  sig
    type t = {
      ...
      mutable length: Gameelements_piqi.float;
    }
  end = Connection
and Vehicle:
  sig
    type t = {
      ...
      mutable speed: Gameelements_piqi.float;
      mutable capacity: int;
      mutable cargo: Gameelements_piqi.goodopt;
      mutable age: int;
      mutable status: Gameelements_piqi.vstatus;
      mutable x: Gameelements_piqi.float;
      mutable y: Gameelements_piqi.float;
      mutable destination: Gameelements_piqi.destlist;
      mutable loc: Gameelements_piqi.intopt;
    }
  end = Vehicle
...
and parse_goodsprofile x =
  ...
  let _price, x = Piqirun.parse_required_field 5 parse_float x in
  let _naturalprice, x = Piqirun.parse_required_field 6 parse_float x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_connection x =
  ...
  let _length, x = Piqirun.parse_required_field 6 parse_float x in
  Piqirun.check_unparsed_fields x;
  {
...
and parse_vehicle x =
  ...
  let _capacity, x = Piqirun.parse_required_field 4 parse_int x in
  let _cargo, x = Piqirun.parse_required_field 5 parse_goodopt x in
  let _age, x = Piqirun.parse_required_field 6 parse_int x in
  let _status, x = Piqirun.parse_required_field 7 parse_vstatus x in
  let _x, x = Piqirun.parse_required_field 8 parse_float x in
  let _y, x = Piqirun.parse_required_field 9 parse_float x in
  let _destination, x = Piqirun.parse_required_field 10 parse_destlist x in
  let _loc, x = Piqirun.parse_required_field 11 parse_intopt x in
  Piqirun.check_unparsed_fields x;
  {
...
and gen__intopt code (x:Gameelements_piqi.intopt) =
  Piqirun.gen_record code [(match x with
...
and gen__goodopt code (x:Gameelements_piqi.goodopt) =
  Piqirun.gen_record code [(match x with
    | `none -> Piqirun.gen_bool_field 1 true
    | `some x -> gen__good 2 x
  )]
...
and gen__goodsprofile code x =
  ...
  let _price = Piqirun.gen_required_field 5 gen__float x.Goodsprofile.price in
  let _naturalprice = Piqirun.gen_required_field 6 gen__float x.Goodsprofile.naturalprice in
...
and gen__connection code x =
  ...
  let _length = Piqirun.gen_required_field 6 gen__float x.Connection.length in
...
and gen__vehicle code x =
  ...
  let _cargo = Piqirun.gen_required_field 5 gen__goodopt x.Vehicle.cargo in
  ...
  let _x = Piqirun.gen_required_field 8 gen__float x.Vehicle.x in
  let _y = Piqirun.gen_required_field 9 gen__float x.Vehicle.y in
  let _destination = Piqirun.gen_required_field 10 gen__destlist x.Vehicle.destination in
  let _loc = Piqirun.gen_required_field 11 gen__intopt x.Vehicle.loc in
  Piqirun.gen_record code (_owner :: _t :: _speed :: _capacity :: _cargo :: _age :: _status :: _x :: _y :: _destination :: _loc :: [])
...
let gen_intopt x = gen__intopt (-1) x
let gen_good x = gen__good (-1) x
let gen_goodopt x = gen__goodopt (-1) x
...
and default_intopt () = `none
and default_good () =
  {
    Good.t = default_rtype ();
    Good.quant = default_int ();
  }
and default_goodopt () = `none
and default_goodsprofile () =
  {
    ...
    Goodsprofile.price = default_float ();
    Goodsprofile.naturalprice = default_float ();
  }
and default_gplist () = []
...
and default_connection () =
  {
    ...
    Connection.length = default_float ();
  }
and default_vehicle () =
  {
    ...
    Vehicle.cargo = default_goodopt ();
    Vehicle.age = default_int ();
    Vehicle.status = default_vstatus ();
    Vehicle.x = default_float ();
    Vehicle.y = default_float ();
    Vehicle.destination = default_destlist ();
    Vehicle.loc = default_intopt ();
  }


let piqi = "\226\202\2304\012gameelements\226\231\249\238\001\017gameelements.piqi\242\189\246\234\004\012ocaml-module\218\244\134\182\012\133\001\170\136\200\184\014\127\218\164\238\191\004\005rtype\170\183\218\222\005\017\232\146\150q\002\218\164\238\191\004\006Lumber\170\183\218\222\005\015\232\146\150q\004\218\164\238\191\004\004Iron\170\183\218\222\005\014\232\146\150q\006\218\164\238\191\004\003Oil\170\183\218\222\005\022\232\146\150q\b\218\164\238\191\004\011Electronics\170\183\218\222\005\018\232\146\150q\n\218\164\238\191\004\007Produce\218\244\134\182\012;\170\136\200\184\0145\218\164\238\191\004\005vtype\170\183\218\222\005\014\232\146\150q\002\218\164\238\191\004\003Car\170\183\218\222\005\016\232\146\150q\004\218\164\238\191\004\005Truck\218\244\134\182\012Z\170\136\200\184\014T\218\164\238\191\004\007vstatus\170\183\218\222\005\018\232\146\150q\002\218\164\238\191\004\007Waiting\170\183\218\222\005\018\232\146\150q\004\218\164\238\191\004\007Driving\170\183\218\222\005\017\232\146\150q\006\218\164\238\191\004\006Broken\218\244\134\182\012E\170\136\200\184\014?\218\164\238\191\004\006intopt\170\183\218\222\005\015\232\146\150q\002\218\164\238\191\004\004None\170\183\218\222\005\024\232\146\150q\004\218\164\238\191\004\004Some\210\171\158\194\006\003int\218\244\134\182\012^\138\233\142\251\014X\210\203\242$!\232\146\150q\002\152\182\154\152\004\223\162\138\147\001\218\164\238\191\004\001t\210\171\158\194\006\005rtype\210\203\242$#\232\146\150q\004\152\182\154\152\004\223\162\138\147\001\218\164\238\191\004\005quant\210\171\158\194\006\003int\218\164\238\191\004\004good\218\244\134\182\012G\170\136\200\184\014A\218\164\238\191\004\007goodopt\170\183\218\222\005\015\232\146\150q\002\218\164\238\191\004\004None\170\183\218\222\005\025\232\146\150q\004\218\164\238\191\004\004Some\210\171\158\194\006\004good\218\244\134\182\012\163\002\138\233\142\251\014\156\002\210\203\242$(\232\146\150q\002\152\182\154\152\004\223\162\138\147\001\218\164\238\191\004