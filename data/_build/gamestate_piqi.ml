...
and parse_gamestate x =
  ...
  let _graph, x = Piqirun.parse_required_field 5 Graph.parse_graph x in
...
and gen__gamestate code x =
  ...
  let _graph = Piqirun.gen_required_field 5 Graph.gen__graph x.Gamestate.graph in
